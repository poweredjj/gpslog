...
If GPS data logging frequency is too slow (especially if you are using slower packet rate), go to ExpressLRS configurator app and increase ```telemetry ratio```.
